...
func TestComputeStartHeight_Unset(t *testing.T) {
	dbNext := int64(100)
	chainHead := int64(150)
	got := computeStartHeight(dbNext, chainHead, false, 0)
	if got != dbNext {
...
func TestComputeStartHeight_ExplicitBelowDB(t *testing.T) {
	dbNext := int64(200)
	chainHead := int64(500)
	got := computeStartHeight(dbNext, chainHead, true, 150)
	if got != dbNext {
...
func TestComputeStartHeight_ExplicitAboveHead(t *testing.T) {
	dbNext := int64(0)
	chainHead := int64(123)
	got := computeStartHeight(dbNext, chainHead, true, 999)
	if got != chainHead {
...
func TestComputeStartHeight_ExplicitWithinRange(t *testing.T) {
	...
	chainHead := int64(100)
	desired := int64(42)
	got := computeStartHeight(dbNext, chainHead, true, desired)
	if got != desired {
...
func TestComputeStartHeight_NegativeClampedToZeroThenDB(t *testing.T) {
	dbNext := int64(5)
	chainHead := int64(100)
	got := computeStartHeight(dbNext, chainHead, true, -10)
	if got != dbNext {
